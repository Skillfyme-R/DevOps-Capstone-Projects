...
import { App }                          from './App';
import { vvTheme, vvThemeDark }         from './styles/theme';
...
function Root() {
  const [isDark, setIsDark] = useState(() => localStorage.getItem('vv-theme') === 'dark');
  ...
  return (
    <ThemeModeContext.Provider value={ctx}>
      <ThemeProvider theme={isDark ? vvThemeDark : vvTheme}>
        <CssBaseline />
        <BrowserRouter>
          <App />
          <ToastContainer
